...
The general shape of the curve is there for this to be considered normally distributed, though it could be argued that the drop off to the right of the data could be too steep and cause for the data to be considered otherwise. A considerable count also falls well to the right of the mean.Because of that my non-binary answer is at 75%. 
